...
require(dirname(__DIR__, 2) . '/public/version.php');
...
if (!$skipdatabase) {
    ...
    if ($interactive) {
        ...
        $prompt = get_string('clitypevaluedefault', 'admin', $options['noreplyemail']);
        $options['noreplyemail'] = cli_input($prompt, $options['noreplyemail']);
    }

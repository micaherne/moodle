...
require_once(dirname(__DIR__, 2) . '/public/backup/util/includes/backup_includes.php');
require_once(dirname(__DIR__, 2) . '/public/backup/util/helper/backup_cron_helper.class.php');

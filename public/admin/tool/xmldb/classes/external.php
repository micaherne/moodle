...
class tool_xmldb_external extends external_api {
    ...
    public static function invoke_move_action($action, $dir, $table, $field, $key, $index, $position) {
        ...
        require_once(dirname(__DIR__) . '/actions/XMLDBAction.class.php');
        require_once(dirname(__DIR__) . '/actions/XMLDBCheckAction.class.php');
        ...
        $actionsroot = dirname(__DIR__) . '/actions';

...
if ($hassiteconfig) {
    $ADMIN->add('experimental', new externalpage('tooldbtransfer', get_string('dbtransfer', 'tool_dbtransfer'),
    ...
    $ADMIN->add('experimental', new externalpage('tooldbexport', get_string('dbexport', 'tool_dbtransfer'),

...
if ($ADMIN->fulltree) {
    $settings->add(new heading('factor_admin/description', '',
        new lang_string('settings:description', 'factor_admin')));
    $settings->add(new heading('factor_admin/settings', new lang_string('settings', 'moodle'), ''));

    $enabled = new configcheckbox('factor_admin/enabled',
    ...
    $settings->add(new configtext('factor_admin/weight',

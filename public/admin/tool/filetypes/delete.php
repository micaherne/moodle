...
$redirecturl = new url('/admin/tool/filetypes/index.php');
...
$PAGE->set_url(new url('/admin/tool/filetypes/delete.php', array('extension' => $extension)));
...
$deleteurl = new url('delete.php', array('extension' => $extension, 'delete' => 1));

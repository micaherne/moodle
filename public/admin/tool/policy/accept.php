...
$PAGE->set_url(new url('/admin/tool/policy/accept.php'));
...
if ($returnurl) {
    ...
    $returnurl = new url('/admin/tool/policy/user.php', ['userid' => $userid]);
} else {
    $returnurl = new url('/admin/tool/policy/acceptances.php');
}

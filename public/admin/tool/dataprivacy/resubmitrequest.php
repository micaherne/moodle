...
$url = new url('/admin/tool/dataprivacy/resubmitrequest.php', ['requestid' => $requestid]);
...
$manageurl = new url('/admin/tool/dataprivacy/datarequests.php');

$originalrequest = \tool_dataprivacy\api::get_request($requestid);
$user = user::get_user($originalrequest->get('userid'));
$stringparams = (object) [
...
$confirmurl = new url($PAGE->url, ['confirm' => 1]);

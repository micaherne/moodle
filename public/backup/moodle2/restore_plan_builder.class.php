...
require_once(__DIR__ . '/restore_root_task.class.php');
require_once(__DIR__ . '/restore_course_task.class.php');
require_once(__DIR__ . '/restore_section_task.class.php');
require_once(__DIR__ . '/restore_activity_task.class.php');
require_once(__DIR__ . '/restore_final_task.class.php');
require_once(__DIR__ . '/restore_block_task.class.php');
require_once(__DIR__ . '/restore_default_block_task.class.php');
require_once(__DIR__ . '/restore_plugin.class.php');
require_once(__DIR__ . '/restore_qbank_plugin.class.php');
require_once(__DIR__ . '/restore_qtype_plugin.class.php');
require_once(__DIR__ . '/restore_qtype_extrafields_plugin.class.php');
require_once(__DIR__ . '/restore_format_plugin.class.php');
require_once(__DIR__ . '/restore_local_plugin.class.php');
require_once(__DIR__ . '/restore_theme_plugin.class.php');
require_once(__DIR__ . '/restore_report_plugin.class.php');
require_once(__DIR__ . '/restore_coursereport_plugin.class.php');
require_once(__DIR__ . '/restore_plagiarism_plugin.class.php');
require_once(__DIR__ . '/restore_gradingform_plugin.class.php');
require_once(__DIR__ . '/restore_enrol_plugin.class.php');
...
require_once(__DIR__ . '/restore_subplugin.class.php');
require_once(__DIR__ . '/restore_settingslib.php');
require_once(__DIR__ . '/restore_stepslib.php');

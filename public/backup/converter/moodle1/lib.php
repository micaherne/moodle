...
require_once(dirname(__DIR__, 2) . '/util/xml/parser/progressive_parser.class.php');
require_once(dirname(__DIR__, 2) . '/util/xml/parser/processors/grouped_parser_processor.class.php');
require_once(dirname(__DIR__, 2) . '/util/dbops/backup_dbops.class.php');
require_once(dirname(__DIR__, 2) . '/util/dbops/backup_controller_dbops.class.php');
require_once(dirname(__DIR__, 2) . '/util/dbops/restore_dbops.class.php');
require_once(dirname(__DIR__, 2) . '/util/xml/contenttransformer/xml_contenttransformer.class.php');

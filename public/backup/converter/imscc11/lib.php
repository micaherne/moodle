...
require_once(__DIR__ . '/../../cc/includes/constants.php');
require_once(__DIR__ . '/../../cc/cc112moodle.php');
require_once(__DIR__ . '/../../cc/validator.php');
...
class imscc11_converter extends base_converter {
    ...
    protected function execute() {
        ...
        $validator = new manifest_validator(__DIR__ . '/../../cc/schemas11');

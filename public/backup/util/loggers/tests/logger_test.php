...
require_once(__DIR__ . '/../base_logger.class.php');
require_once(__DIR__ . '/../error_log_logger.class.php');
require_once(__DIR__ . '/../output_text_logger.class.php');
require_once(__DIR__ . '/../output_indented_logger.class.php');
require_once(__DIR__ . '/../database_logger.class.php');
require_once(__DIR__ . '/../file_logger.class.php');

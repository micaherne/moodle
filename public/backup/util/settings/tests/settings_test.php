...
require_once(dirname(__DIR__) . '/base_setting.class.php');
require_once(dirname(__DIR__) . '/backup_setting.class.php');
require_once(dirname(__DIR__) . '/setting_dependency.class.php');
require_once(dirname(__DIR__) . '/root/root_backup_setting.class.php');
require_once(dirname(__DIR__) . '/activity/activity_backup_setting.class.php');
require_once(dirname(__DIR__) . '/section/section_backup_setting.class.php');
require_once(dirname(__DIR__) . '/course/course_backup_setting.class.php');

...
global $CFG;
require_once(__DIR__ . '/../progressive_parser.class.php');
require_once(__DIR__ . '/../processors/progressive_parser_processor.class.php');
require_once(__DIR__ . '/../processors/simplified_parser_processor.class.php');
require_once(__DIR__ . '/../processors/grouped_parser_processor.class.php');

...
global $CFG;
require_once(dirname(__DIR__) . '/xml_writer.class.php');
require_once(dirname(__DIR__) . '/output/xml_output.class.php');
require_once(dirname(__DIR__) . '/output/memory_xml_output.class.php');
require_once(dirname(__DIR__) . '/contenttransformer/xml_contenttransformer.class.php');

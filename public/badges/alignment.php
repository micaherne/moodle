...
$currenturl = new url('/badges/alignment.php', ['id' => $badge->id]);
...
$url = new url('/badges/alignment.php', ['id' => $badge->id, 'action' => $action, 'alignmentid' => $alignmentid]);
...
if ($alignmentid || $action == 'add' || $action == 'edit') {
    ...
    if (!$badge->is_active() && !$badge->is_locked()) {
        $urlbutton = new url('/badges/alignment.php', ['id' => $badge->id, 'action' => 'add']);

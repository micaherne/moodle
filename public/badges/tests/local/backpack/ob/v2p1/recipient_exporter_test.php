...
global $CFG;
require_once(dirname(__DIR__) . '/v2p0/recipient_exporter_test.php');

use core_badges\local\backpack\ob\v2p0\recipient_exporter_test as recipient_exporter_v2p0_test;

/**
 * Tests for achievement subject (or recipient) exporter class in the Open Badges v2.1 backpack integration.
 ...
 */
final class recipient_exporter_test extends recipient_exporter_v2p0_test {
    /**

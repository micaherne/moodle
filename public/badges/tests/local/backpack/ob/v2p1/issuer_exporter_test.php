...
global $CFG;
require_once(dirname(__DIR__) . '/v2p0/issuer_exporter_test.php');

use core_badges\local\backpack\ob\v2p0\issuer_exporter_test as issuer_exporter_v2p0_test;

/**
 * Tests for issuer exporter class in the Open Badges v2.1 backpack integration.
 ...
 */
final class issuer_exporter_test extends issuer_exporter_v2p0_test {
    /**

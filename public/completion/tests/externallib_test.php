...
final class externallib_test extends \core_external\tests\externallib_testcase {
    ...
    public function test_get_course_completion_status(): void {
        ...
        require_once(__DIR__ . '/../criteria/completion_criteria_self.php');
        require_once(__DIR__ . '/../criteria/completion_criteria_date.php');
        require_once(__DIR__ . '/../criteria/completion_criteria_unenrol.php');
        ...
        require_once(__DIR__ . '/../criteria/completion_criteria_role.php');

...
final class grouping_handler_test extends advanced_testcase {
    ...
    public function test_get_instance_context(): void {
        ...
        $this->assertInstanceOf(course::class, $this->handler->get_instance_context($grouping->id));
        $this->assertSame(course::instance($course->id), $this->handler->get_instance_context($grouping->id));
    }

...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new heading('mlbackend_python/serversettingsinfo', '', $info));

    $settings->add(new configcheckbox('mlbackend_python/useserver', get_string('useserver', 'mlbackend_python'),
                       get_string('useserverdesc', 'mlbackend_python'), 0));

    $settings->add(new configtext('mlbackend_python/host', get_string('host', 'mlbackend_python'),
                       get_string('host', 'mlbackend_python'), '', PARAM_HOST));
    $settings->hide_if('mlbackend_python/host', 'mlbackend_python/useserver', 'neq', '1');

    $settings->add(new configtext('mlbackend_python/port', get_string('port', 'mlbackend_python'),
                       get_string('port', 'mlbackend_python'), '', PARAM_INT));
    $settings->hide_if('mlbackend_python/port', 'mlbackend_python/useserver', 'neq', '1');

    $settings->add(new configcheckbox('mlbackend_python/secure', get_string('secure', 'mlbackend_python'),
                       get_string('securedesc', 'mlbackend_python'), 0));
    $settings->hide_if('mlbackend_python/secure', 'mlbackend_python/useserver', 'neq', '1');

    $settings->add(new configtext('mlbackend_python/username', get_string('username', 'mlbackend_python'),
    ...
    $settings->add(new configtext('mlbackend_python/password', get_string('password', 'mlbackend_python'),

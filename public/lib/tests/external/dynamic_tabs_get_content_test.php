...
require_once(dirname(__DIR__) . '/fixtures/testeable_dynamic_tab.php');
 ...
 */
final class dynamic_tabs_get_content_test extends \core_external\tests\externallib_testcase {
    /**
     * Text execute method
     */

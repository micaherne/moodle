...
final class message_test extends \advanced_testcase {
    ...
    public function test_send_message(): void {
        ...
        $this->assertFileExists(\core\component::component_path('message_email', 'version.php'));
        $this->assertFileExists(\core\component::component_path('message_popup', 'version.php'));

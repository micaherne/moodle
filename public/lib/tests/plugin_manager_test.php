...
final class plugin_manager_test extends \advanced_testcase {
    ...
    public function test_get_plugins(): void {
        ...
        $plugininfos3 = plugin_manager::instance()->get_plugins();
    ...
    public function test_orphaned_plugininfo_has_component(): void {
        ...
        $plugininfo = plugin_manager::instance()->get_plugin_info('orphanexample_name');
    ...
    public function test_plugin_manager_deprecated_plugintype(): void {
        ...
        $this->assertInstanceOf(url::class, $uninstallurl);

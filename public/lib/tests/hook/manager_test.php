...
final class manager_test extends \advanced_testcase {
    ...
    protected function setup_hooktest_plugin(): void {
        ...
        $this->add_mocked_plugintype('fake', dirname(__DIR__) . '/fixtures/hook/fakeplugins');
        $this->add_mocked_plugin('fake', 'hooktest', dirname(__DIR__) . '/fixtures/hook/fakeplugins/hooktest');
    }

...
';
    ...
    protected static function fill_classmap_cache() {
        ...
        self::load_classes('core', __DIR__ . '/');
        self::load_legacy_classes(__DIR__ . '/../', true);
    ...
    protected static function fill_classmap_renames_cache() {
        ...
        self::load_renamed_classes(__DIR__ . '/../');
    ...
    public static function component_path(?string $component, ?string $path = null): string {
        ...
        if ($component === null) {
            return \core\component::from_mono_path($suffix);
        }
    ...
    public static function is_inside_codebase(string $abspath, string $separator = '/'): bool {
        global $CFG;
        return str_starts_with($abspath, \core\component::from_mono_path($separator));
    }

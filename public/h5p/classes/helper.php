...
class helper {
    ...
    public static function get_h5p_tools_info(): array {
        ...
        $status = filter_get_active_state('displayh5p', system::instance()->id);
    ...
    public static function get_core_assets(?string $component = null): array {
        ...
        foreach (core::$styles as $style) {
            ...
            $PAGE->requires->css(new url($liburl . $style . $cachebuster));
        }
        // Add core JavaScript.
     ...
     */
    public static function get_export_info(string $exportfilename, ?url $url = null, ?factory $factory = null): ?array {

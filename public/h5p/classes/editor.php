...
class editor {
    ...
    private function get_editor_translations(string $language): array {
        ...
        if (!file_exists(\core\component::from_mono_path(autoloader::get_h5p_editor_library_base($languagescript)))) {
        ...
        $langcontent = file_get_contents(\core\component::from_mono_path(autoloader::get_h5p_editor_library_base($languagescript)));

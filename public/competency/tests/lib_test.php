...
final class lib_test extends \advanced_testcase {
    ...
    public function test_comment_add_user_competency(): void {
        ...
        assign_capability('moodle/competency:planview', CAP_ALLOW, $reviewerroleid, system::instance()->id, true);
    ...
    public function test_comment_add_plan(): void {
        ...
        $reviewerroleid = $dg->create_role();
        assign_capability('moodle/competency:planviewowndraft', CAP_ALLOW, $userroleid, system::instance()->id, true);
        assign_capability('moodle/competency:planviewown', CAP_ALLOW, $userroleid, system::instance()->id, true);
        assign_capability('moodle/competency:planviewdraft', CAP_ALLOW, $reviewerroleid, system::instance()->id, true);
        assign_capability('moodle/competency:planmanage', CAP_ALLOW, $reviewerroleid, system::instance()->id, true);
        assign_capability('moodle/competency:plancomment', CAP_ALLOW, $reviewerroleid, system::instance()->id, true);
        $dg->role_assign($userroleid, $u1->id, context_user::instance($u1->id));
        $dg->role_assign($reviewerroleid, $u2->id, context_user::instance($u1->id));
        $dg->role_assign($reviewerroleid, $u3->id, system::instance());
        accesslib_clear_all_caches_for_unit_testing();

...
final class cm_test extends \advanced_testcase {
    ...
    public static function setupBeforeClass(): void {
        ...
        require_once(dirname(__DIR__, 3) . '/fixtures/format_theunittest.php');
        require_once(dirname(__DIR__, 3) . '/fixtures/format_theunittest_output_course_format_state.php');
    }

...
require_once(dirname(__DIR__, 2) . '/pagetypes/essay.php');
require_once(dirname(__DIR__, 2) . '/pagetypes/matching.php');
require_once(dirname(__DIR__, 2) . '/pagetypes/multichoice.php');

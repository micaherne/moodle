...
$ADMIN->add('modsettings', new category('modassignfolder', new lang_string('pluginname', 'mod_assign'), $module->is_enabled() === false));

$settings = new settingpage($section, get_string('settings', 'mod_assign'), 'moodle/site:config', $module->is_enabled() === false);
...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new configselect('assign/feedback_plugin_for_gradebook',
                                                  $name,
                                                  $description,
    ...
    $settings->add(new configcheckbox('assign/showrecentsubmissions',
                                                    $name,
                                                    $description,
                                                    0));
    ...
    $settings->add(new configcheckbox('assign/submissionreceipts',
                                                    $name,
                                                    $description,
                                                    1));
    ...
    $setting = new configtextarea('assign/submissionstatement',
                                                    $name,
                                                    $description,
                                                    $default);
    ...
    $setting = new configtextarea('assign/submissionstatementteamsubmission',
        $name,
        $description,
        $default);
    $setting->set_force_ltr(false);
    ...
    $setting = new configtextarea('assign/submissionstatementteamsubmissionallsubmit',
        $name,
        $description,
        $default);
    $setting->set_force_ltr(false);
    ...
    $settings->add(new configselect('assign/maxperpage',
                                                    $name,
                                                    $description,
                                                    -1,
                                                    $options));
    ...
    $setting = new configduration('assign/allowsubmissionsfromdate',
                                                    $name,
                                                    $description,
                                                    0);
    $setting->set_enabled_flag_options(flag::ENABLED, true);
    $setting->set_advanced_flag_options(flag::ENABLED, false);
    $settings->add($setting);

    $name = new lang_string('duedate', 'mod_assign');
    $description = new lang_string('duedate_help', 'mod_assign');
    $setting = new configduration('assign/duedate',
                                                    $name,
                                                    $description,
                                                    604800);
    $setting->set_enabled_flag_options(flag::ENABLED, true);
    ...
    $setting = new configduration('assign/cutoffdate',
                                                    $name,
                                                    $description,
                                                    1209600);
    $setting->set_enabled_flag_options(flag::ENABLED, false);
    $setting->set_advanced_flag_options(flag::ENABLED, false);
    $settings->add($setting);
    ...
    $setting = new configselect('mod_assign/defaultgradetype',
                                                    $name,
                                                    $description,
                                                    GRADE_TYPE_VALUE, [
    ...
    if (count($choices) > 1) {
        $setting = new configselect('mod_assign/defaultgradescale',
            $name,
            $description,
            '', $choices);
    } else {
        $setting = new configempty('mod_assign/defaultgradescale',
            $name,
            $description
        );
    }
    ...
    $setting = new configduration('assign/gradingduedate',
                                                    $name,
                                                    $description,
                                                    1209600);
    $setting->set_enabled_flag_options(flag::ENABLED, true);
    ...
    $setting = new configcheckbox('assign/submissiondrafts',
                                                    $name,
                                                    $description,
                                                    0);
    $setting->set_advanced_flag_options(flag::ENABLED, false);
    ...
    $setting = new configcheckbox('assign/requiresubmissionstatement',
                                                    $name,
                                                    $description,
                                                    0);
    $setting->set_advanced_flag_options(flag::ENABLED, false);
    ...
    $setting = new configselect('assign/maxattempts', $name, $description, 1, $options);
    $setting->set_advanced_flag_options(flag::ENABLED, false);
    $setting->set_locked_flag_options(flag::ENABLED, false);
    $settings->add($setting);
    ...
    $setting = new configselect('assign/attemptreopenmethod', $name, $description, 'untilpass', $options);
    $setting->set_advanced_flag_options(flag::ENABLED, false);
    $setting->set_locked_flag_options(flag::ENABLED, false);
    $settings->add($setting);
    ...
    $setting = new configcheckbox('assign/teamsubmission',
                                                    $name,
                                                    $description,
                                                    0);
    $setting->set_advanced_flag_options(flag::ENABLED, false);
    ...
    $setting = new configcheckbox('assign/preventsubmissionnotingroup',
        $name,
        $description,
        0);
    $setting->set_advanced_flag_options(flag::ENABLED, false);
    ...
    $setting = new configcheckbox('assign/requireallteammemberssubmit',
                                                    $name,
                                                    $description,
                                                    0);
    $setting->set_advanced_flag_options(flag::ENABLED, false);
    ...
    $setting = new configempty('assign/teamsubmissiongroupingid',
                                                    $name,
                                                    $description);
    $setting->set_advanced_flag_options(flag::ENABLED, false);
    $settings->add($setting);
    ...
    $setting = new configcheckbox('assign/sendnotifications',
                                                    $name,
                                                    $description,
                                                    0);
    $setting->set_advanced_flag_options(flag::ENABLED, false);
    ...
    $setting = new configcheckbox('assign/sendlatenotifications',
                                                    $name,
                                                    $description,
                                                    0);
    $setting->set_advanced_flag_options(flag::ENABLED, false);
    ...
    $setting = new configcheckbox('assign/sendstudentnotifications',
                                                    $name,
                                                    $description,
                                                    1);
    $setting->set_advanced_flag_options(flag::ENABLED, false);
    ...
    $setting = new configcheckbox('assign/blindmarking',
                                                    $name,
                                                    $description,
                                                    0);
    $setting->set_advanced_flag_options(flag::ENABLED, false);
    ...
    $setting = new configcheckbox('assign/hidegrader',
                                                    $name,
                                                    $description,
                                                    0);
    $setting->set_advanced_flag_options(flag::ENABLED, false);
    ...
    $setting = new configcheckbox('assign/markingworkflow',
                                                    $name,
                                                    $description,
                                                    0);
    $setting->set_advanced_flag_options(flag::ENABLED, false);
    ...
    $setting = new configcheckbox('assign/markingallocation',
                                                    $name,
                                                    $description,
                                                    0);
    $setting->set_advanced_flag_options(flag::ENABLED, false);
    ...
    $setting = new configcheckbox('assign/markinganonymous',
                                                    $name,
                                                    $description,
                                                    0);
    $setting->set_advanced_flag_options(flag::ENABLED, false);
...
$ADMIN->add('modassignfolder', new category('assignsubmissionplugins',
...
$ADMIN->add('modassignfolder', new category('assignfeedbackplugins',
...
foreach (plugin_manager::instance()->get_plugins_of_type('assignsubmission') as $plugin) {
    /** @var \mod_assign\plugininfo\assignsubmission $plugin */
    $plugin->load_settings($ADMIN, 'assignsubmissionplugins', $hassiteconfig);
}

foreach (plugin_manager::instance()->get_plugins_of_type('assignfeedback') as $plugin) {

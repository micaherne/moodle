...
$url = new url('/mod/glossary/export.php', array('id'=>$id));
if ($cat !== 0) {
    $url->param('cat', $cat);
}
if ($mode !== '') {
...
echo $OUTPUT->header();
$backlink = html_writer::link(new url('view.php', ['id' => $cm->id]),
...
$exporturl = url::make_pluginfile_url($context->id, 'mod_glossary', 'export', 0, "/$cat/", 'export.xml', true);

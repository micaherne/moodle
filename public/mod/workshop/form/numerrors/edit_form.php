...
require_once(\core\component::component_path('mod_workshop', 'lib.php'));   // module library
require_once(\core\component::component_path('mod_workshop', 'form/edit_form.php'));    // parent class definition

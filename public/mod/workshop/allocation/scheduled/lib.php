...
require_once(\core\component::component_path('mod_workshop', 'allocation/lib.php'));            // interface definition
require_once(\core\component::component_path('mod_workshop', 'locallib.php'));    // workshop internal API
require_once(\core\component::component_path('workshopallocation_random', 'lib.php'));     // random allocator

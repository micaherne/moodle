...
if ($ADMIN->fulltree) {
    ...
    $page = new settingpage('theme_boost_general', get_string('generalsettings', 'theme_boost'));
    ...
    $setting = new configtext('theme_boost/unaddableblocks',
    ...
    $setting = new configthemepreset($name, $title, $description, $default, $choices, 'boost');
    ...
    // Advanced settings.
    $page = new settingpage('theme_boost_advanced', get_string('advancedsettings', 'theme_boost'));

    // Raw SCSS to include before the content.
    $setting = new scsscode('theme_boost/scsspre',
        get_string('rawscsspre', 'theme_boost'), get_string('rawscsspre_desc', 'theme_boost'), '', PARAM_RAW);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);

    // Raw SCSS to include after the content.
    $setting = new scsscode('theme_boost/scss', get_string('rawscss', 'theme_boost'),
